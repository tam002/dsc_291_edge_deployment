...
Benchmarks Phi-3 Mini 3.82B Instruct using Apple MLX framework.
...
MLX_REPO    = "mlx-community/Phi-3-mini-4k-instruct-mlx"
MLX_DIR     = os.path.expanduser("~/models/phi3_mlx")
