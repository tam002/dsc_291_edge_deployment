# llm-edge-benchmark — Phi-3 Mini 3.82B Instruct

> Edge deployment benchmark for Phi-3 Mini 3.82B Instruct on Apple Silicon (M1).  
> Frameworks: **llama.cpp (Metal)** and **MLX**.  
> Primary metric: **tokens/joule** — throughput per unit of battery drain.

**Why this model?** Lowest perplexity in Phase 1 testing (6.82 vs 12.33 for Llama 3.2 3B) — significantly better output quality and language understanding for accuracy-critical tasks.
...
|-------|-----------|-------|---------|---------|------------|--------|
| Q4_K_M | 2.23 | 6.82 ± 0.25 | 72.66 ± 1.05 | 15.95 ± 0.33 | 2,578 | TBD |
