...
MODELS = {
    "llama32": {
        ...
        "path": os.path.expanduser(
            "~/models/llama3.2_3b/Llama-3.2-3B-Instruct-Q4_K_M.gguf"
        ),
        "ctx": 4096,
        "chat_format": "llama-3",
...
def build_ui(default_model: str = "llama32"):
...
def main():
    ...
    parser.add_argument("--model", choices=list(MODELS.keys()), default="llama32")
    parser.add_argument("--port", type=int, default=7860)
    parser.add_argument("--share", action="store_true")
    args = parser.parse_args()

    app = build_ui("llama32")
